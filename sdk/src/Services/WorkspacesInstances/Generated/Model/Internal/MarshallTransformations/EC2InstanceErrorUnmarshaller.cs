...
namespace Amazon.WorkspacesInstances.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EC2InstanceErrorUnmarshaller : ICborUnmarshaller<EC2InstanceError, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public EC2InstanceError Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (context.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "EC2ErrorCode":
                        {
                            context.AddPathSegment("EC2ErrorCode");
                    ...
                    case "EC2ErrorMessage":
                        {
                            context.AddPathSegment("EC2ErrorMessage");
                            var unmarshaller = CborStringUnmarshaller.Instance;
                    ...
                    case "EC2ExceptionType":
                        {
                            context.AddPathSegment("EC2ExceptionType");
                            var unmarshaller = CborStringUnmarshaller.Instance;
