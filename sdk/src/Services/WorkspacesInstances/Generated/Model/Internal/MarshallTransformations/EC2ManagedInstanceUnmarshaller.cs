...
namespace Amazon.WorkspacesInstances.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EC2ManagedInstanceUnmarshaller : ICborUnmarshaller<EC2ManagedInstance, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public EC2ManagedInstance Unmarshall(CborUnmarshallerContext context)
        {
