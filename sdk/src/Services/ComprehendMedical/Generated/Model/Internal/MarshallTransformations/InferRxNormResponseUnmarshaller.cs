...
namespace Amazon.ComprehendMedical.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InferRxNormResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("InferRxNorm");
                    ...
                    case "Entities":
                        {
                            ...
                            var unmarshaller = new CborListUnmarshaller<RxNormEntity, RxNormEntityUnmarshaller>(RxNormEntityUnmarshaller.Instance);
