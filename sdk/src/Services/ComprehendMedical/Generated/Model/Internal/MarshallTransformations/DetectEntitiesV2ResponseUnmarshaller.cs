...
namespace Amazon.ComprehendMedical.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DetectEntitiesV2ResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("DetectEntitiesV2");
            ...
            while (context.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "UnmappedAttributes":
                        {
                            context.AddPathSegment("UnmappedAttributes");
                            var unmarshaller = new CborListUnmarshaller<UnmappedAttribute, UnmappedAttributeUnmarshaller>(UnmappedAttributeUnmarshaller.Instance);
