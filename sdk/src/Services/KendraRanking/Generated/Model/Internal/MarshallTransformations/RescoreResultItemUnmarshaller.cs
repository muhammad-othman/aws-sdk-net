...
namespace Amazon.KendraRanking.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RescoreResultItemUnmarshaller : ICborUnmarshaller<RescoreResultItem, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public RescoreResultItem Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (context.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "DocumentId":
                        {
                            context.AddPathSegment("DocumentId");
