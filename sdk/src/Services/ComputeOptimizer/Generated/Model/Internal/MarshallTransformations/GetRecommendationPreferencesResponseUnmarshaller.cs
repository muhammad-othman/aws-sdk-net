...
namespace Amazon.ComputeOptimizer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetRecommendationPreferencesResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("GetRecommendationPreferences");
            ...
            while (context.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "recommendationPreferencesDetails":
                        {
                            context.AddPathSegment("RecommendationPreferencesDetails");
                            var unmarshaller = new CborListUnmarshaller<RecommendationPreferencesDetail, RecommendationPreferencesDetailUnmarshaller>(RecommendationPreferencesDetailUnmarshaller.Instance);
                            response.RecommendationPreferencesDetails = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    default:
