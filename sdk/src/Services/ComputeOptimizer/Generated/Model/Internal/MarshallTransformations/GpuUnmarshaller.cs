...
namespace Amazon.ComputeOptimizer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GpuUnmarshaller : ICborUnmarshaller<Gpu, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public Gpu Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (context.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "gpuCount":
                        {
                            context.AddPathSegment("GpuCount");
                    ...
                    case "gpuMemorySizeInMiB":
                        {
                            context.AddPathSegment("GpuMemorySizeInMiB");
                            var unmarshaller = CborNullableIntUnmarshaller.Instance;
