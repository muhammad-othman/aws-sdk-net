...
namespace Amazon.ComputeOptimizer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetIdleRecommendationsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("GetIdleRecommendations");
            ...
            while (context.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "errors":
                        {
                            ...
                            var unmarshaller = new CborListUnmarshaller<IdleRecommendationError, IdleRecommendationErrorUnmarshaller>(IdleRecommendationErrorUnmarshaller.Instance);
                    ...
                    case "idleRecommendations":
                        {
                            context.AddPathSegment("IdleRecommendations");
                            var unmarshaller = new CborListUnmarshaller<IdleRecommendation, IdleRecommendationUnmarshaller>(IdleRecommendationUnmarshaller.Instance);
                            response.IdleRecommendations = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    case "nextToken":
