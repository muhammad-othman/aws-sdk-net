...
{
    /// <summary>
    /// Response Unmarshaller for ListAlarmMuteRules operation
    /// </summary>  
    public class ListAlarmMuteRulesResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAlarmMuteRulesResponse response = new ListAlarmMuteRulesResponse();
            var reader = context.Reader;
            context.AddPathSegment("ListAlarmMuteRules");
            ...
            while (context.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "AlarmMuteRuleSummaries":
                        {
                            context.AddPathSegment("AlarmMuteRuleSummaries");
                            var unmarshaller = new CborListUnmarshaller<AlarmMuteRuleSummary, AlarmMuteRuleSummaryUnmarshaller>(AlarmMuteRuleSummaryUnmarshaller.Instance);
                            response.AlarmMuteRuleSummaries = unmarshaller.Unmarshall(context);
        ...
        private static ListAlarmMuteRulesResponseUnmarshaller _instance = new ListAlarmMuteRulesResponseUnmarshaller();        

        internal static ListAlarmMuteRulesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAlarmMuteRulesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
