...
namespace Amazon.CloudWatch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeAnomalyDetectorsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("DescribeAnomalyDetectors");
            ...
            while (context.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "AnomalyDetectors":
                        {
                            context.AddPathSegment("AnomalyDetectors");
                            var unmarshaller = new CborListUnmarshaller<AnomalyDetector, AnomalyDetectorUnmarshaller>(AnomalyDetectorUnmarshaller.Instance);
                            response.AnomalyDetectors = unmarshaller.Unmarshall(context);
