...
namespace Amazon.CloudWatch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ScheduleConfigurationUnmarshaller : ICborUnmarshaller<ScheduleConfiguration, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public ScheduleConfiguration Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (context.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "EndTimeOffset":
                        {
                            context.AddPathSegment("EndTimeOffset");
                    ...
                    case "StartTimeOffset":
                        {
                            context.AddPathSegment("StartTimeOffset");
                            var unmarshaller = CborNullableLongUnmarshaller.Instance;
