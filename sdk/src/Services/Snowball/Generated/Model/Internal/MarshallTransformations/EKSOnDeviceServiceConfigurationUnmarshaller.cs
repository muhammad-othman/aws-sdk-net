...
namespace Amazon.Snowball.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EKSOnDeviceServiceConfigurationUnmarshaller : ICborUnmarshaller<EKSOnDeviceServiceConfiguration, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public EKSOnDeviceServiceConfiguration Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (context.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "EKSAnywhereVersion":
                        {
                            context.AddPathSegment("EKSAnywhereVersion");
                    ...
                    case "KubernetesVersion":
                        {
                            context.AddPathSegment("KubernetesVersion");
                            var unmarshaller = CborStringUnmarshaller.Instance;
