...
namespace Amazon.Snowball.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListLongTermPricingResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("ListLongTermPricing");
            ...
            while (context.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "LongTermPricingEntries":
                        {
                            context.AddPathSegment("LongTermPricingEntries");
                            var unmarshaller = new CborListUnmarshaller<LongTermPricingListEntry, LongTermPricingListEntryUnmarshaller>(LongTermPricingListEntryUnmarshaller.Instance);
                            response.LongTermPricingEntries = unmarshaller.Unmarshall(context);
