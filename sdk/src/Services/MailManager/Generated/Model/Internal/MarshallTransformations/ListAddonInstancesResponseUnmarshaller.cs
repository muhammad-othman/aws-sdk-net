...
namespace Amazon.MailManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListAddonInstancesResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("ListAddonInstances");
            ...
            while (context.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "AddonInstances":
                        {
                            context.AddPathSegment("AddonInstances");
                            var unmarshaller = new CborListUnmarshaller<AddonInstance, AddonInstanceUnmarshaller>(AddonInstanceUnmarshaller.Instance);
                            response.AddonInstances = unmarshaller.Unmarshall(context);
