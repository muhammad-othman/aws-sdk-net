...
namespace Amazon.MailManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetArchiveResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("GetArchive");
            ...
            while (context.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "ArchiveArn":
                        {
                            context.AddPathSegment("ArchiveArn");
                    ...
                    case "ArchiveState":
                        {
                            ...
                            var unmarshaller = CborStringUnmarshaller.Instance;
                            response.ArchiveState = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    ...
                    case "Retention":
                        {
                            context.AddPathSegment("Retention");
