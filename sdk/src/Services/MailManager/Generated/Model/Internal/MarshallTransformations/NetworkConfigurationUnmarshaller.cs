...
namespace Amazon.MailManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class NetworkConfigurationUnmarshaller : ICborUnmarshaller<NetworkConfiguration, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public NetworkConfiguration Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (context.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "PrivateNetworkConfiguration":
                        {
                            context.AddPathSegment("PrivateNetworkConfiguration");
                    ...
                    case "PublicNetworkConfiguration":
                        {
                            context.AddPathSegment("PublicNetworkConfiguration");
