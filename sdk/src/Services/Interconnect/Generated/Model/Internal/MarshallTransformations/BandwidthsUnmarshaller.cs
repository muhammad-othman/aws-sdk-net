...
{
    /// <summary>
    /// Response Unmarshaller for Bandwidths Object
    /// </summary>  
    public class BandwidthsUnmarshaller : ICborUnmarshaller<Bandwidths, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public Bandwidths Unmarshall(CborUnmarshallerContext context)
        {
            Bandwidths unmarshalledObject = new Bandwidths();
            ...
            while (context.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "supported":
                        {
                            context.AddPathSegment("Supported");
                            var unmarshaller = new CborListUnmarshaller<string, CborStringUnmarshaller>(CborStringUnmarshaller.Instance);
        ...
        private static BandwidthsUnmarshaller _instance = new BandwidthsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static BandwidthsUnmarshaller Instance
        {
            get
            {
                return _instance;
