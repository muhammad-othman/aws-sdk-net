...
namespace Amazon.AppStream.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeAppBlockBuildersResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("DescribeAppBlockBuilders");
            ...
            while (context.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "AppBlockBuilders":
                        {
                            context.AddPathSegment("AppBlockBuilders");
                            var unmarshaller = new CborListUnmarshaller<AppBlockBuilder, AppBlockBuilderUnmarshaller>(AppBlockBuilderUnmarshaller.Instance);
                            response.AppBlockBuilders = unmarshaller.Unmarshall(context);
