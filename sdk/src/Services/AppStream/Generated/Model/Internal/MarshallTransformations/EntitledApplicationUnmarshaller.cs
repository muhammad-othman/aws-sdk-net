...
namespace Amazon.AppStream.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EntitledApplicationUnmarshaller : ICborUnmarshaller<EntitledApplication, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public EntitledApplication Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (context.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "ApplicationIdentifier":
                        {
                            context.AddPathSegment("ApplicationIdentifier");
                            var unmarshaller = CborStringUnmarshaller.Instance;
                            unmarshalledObject.ApplicationIdentifier = unmarshaller.Unmarshall(context);
