...
namespace Amazon.AppStream.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeUsageReportSubscriptionsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("DescribeUsageReportSubscriptions");
            ...
            while (context.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "UsageReportSubscriptions":
                        {
                            context.AddPathSegment("UsageReportSubscriptions");
                            var unmarshaller = new CborListUnmarshaller<UsageReportSubscription, UsageReportSubscriptionUnmarshaller>(UsageReportSubscriptionUnmarshaller.Instance);
