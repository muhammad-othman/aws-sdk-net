...
{
    /// <summary>
    /// Response Unmarshaller for DescribeSoftwareAssociations operation
    /// </summary>  
    public class DescribeSoftwareAssociationsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeSoftwareAssociationsResponse response = new DescribeSoftwareAssociationsResponse();
            var reader = context.Reader;
            context.AddPathSegment("DescribeSoftwareAssociations");
            ...
            while (context.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "AssociatedResource":
                        {
                            context.AddPathSegment("AssociatedResource");
                            var unmarshaller = CborStringUnmarshaller.Instance;
                            response.AssociatedResource = unmarshaller.Unmarshall(context);
                    ...
                    case "SoftwareAssociations":
                        {
                            context.AddPathSegment("SoftwareAssociations");
                            var unmarshaller = new CborListUnmarshaller<SoftwareAssociations, SoftwareAssociationsUnmarshaller>(SoftwareAssociationsUnmarshaller.Instance);
                            response.SoftwareAssociations = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    default:
        ...
        private static DescribeSoftwareAssociationsResponseUnmarshaller _instance = new DescribeSoftwareAssociationsResponseUnmarshaller();        

        internal static DescribeSoftwareAssociationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeSoftwareAssociationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
