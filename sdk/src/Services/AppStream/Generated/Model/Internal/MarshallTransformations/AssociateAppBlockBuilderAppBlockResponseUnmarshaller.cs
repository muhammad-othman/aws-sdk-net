...
namespace Amazon.AppStream.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AssociateAppBlockBuilderAppBlockResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("AssociateAppBlockBuilderAppBlock");
            ...
            while (context.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "AppBlockBuilderAppBlockAssociation":
                        {
                            context.AddPathSegment("AppBlockBuilderAppBlockAssociation");
                            var unmarshaller = AppBlockBuilderAppBlockAssociationUnmarshaller.Instance;
                            response.AppBlockBuilderAppBlockAssociation = unmarshaller.Unmarshall(context);
