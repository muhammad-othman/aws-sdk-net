...
namespace Amazon.AppStream.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CertificateBasedAuthPropertiesUnmarshaller : ICborUnmarshaller<CertificateBasedAuthProperties, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public CertificateBasedAuthProperties Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (context.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "CertificateAuthorityArn":
                        {
                            context.AddPathSegment("CertificateAuthorityArn");
