...
{
    /// <summary>
    /// Response Unmarshaller for ListExportImageTasks operation
    /// </summary>  
    public class ListExportImageTasksResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListExportImageTasksResponse response = new ListExportImageTasksResponse();
            var reader = context.Reader;
            context.AddPathSegment("ListExportImageTasks");
            ...
            while (context.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "ExportImageTasks":
                        {
                            context.AddPathSegment("ExportImageTasks");
                            var unmarshaller = new CborListUnmarshaller<ExportImageTask, ExportImageTaskUnmarshaller>(ExportImageTaskUnmarshaller.Instance);
                            response.ExportImageTasks = unmarshaller.Unmarshall(context);
        ...
        private static ListExportImageTasksResponseUnmarshaller _instance = new ListExportImageTasksResponseUnmarshaller();        

        internal static ListExportImageTasksResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListExportImageTasksResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
