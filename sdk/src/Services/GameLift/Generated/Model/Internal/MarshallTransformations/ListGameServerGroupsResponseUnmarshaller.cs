...
namespace Amazon.GameLift.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListGameServerGroupsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("ListGameServerGroups");
            ...
            while (context.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "GameServerGroups":
                        {
                            context.AddPathSegment("GameServerGroups");
                            var unmarshaller = new CborListUnmarshaller<GameServerGroup, GameServerGroupUnmarshaller>(GameServerGroupUnmarshaller.Instance);
