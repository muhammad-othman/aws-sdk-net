...
namespace Amazon.GameLift.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeGameSessionDetailsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("DescribeGameSessionDetails");
            ...
            while (context.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "GameSessionDetails":
                        {
                            context.AddPathSegment("GameSessionDetails");
                            var unmarshaller = new CborListUnmarshaller<GameSessionDetail, GameSessionDetailUnmarshaller>(GameSessionDetailUnmarshaller.Instance);
