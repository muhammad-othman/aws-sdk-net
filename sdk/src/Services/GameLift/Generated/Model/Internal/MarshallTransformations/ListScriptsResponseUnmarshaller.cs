...
namespace Amazon.GameLift.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListScriptsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("ListScripts");
            ...
            while (context.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "Scripts":
                        {
                            context.AddPathSegment("Scripts");
                            var unmarshaller = new CborListUnmarshaller<Script, ScriptUnmarshaller>(ScriptUnmarshaller.Instance);
