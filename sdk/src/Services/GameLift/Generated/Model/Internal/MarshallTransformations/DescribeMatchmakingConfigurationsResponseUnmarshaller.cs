...
namespace Amazon.GameLift.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeMatchmakingConfigurationsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("DescribeMatchmakingConfigurations");
            ...
            while (context.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "Configurations":
                        {
                            context.AddPathSegment("Configurations");
                            var unmarshaller = new CborListUnmarshaller<MatchmakingConfiguration, MatchmakingConfigurationUnmarshaller>(MatchmakingConfigurationUnmarshaller.Instance);
