...
namespace Amazon.GameLift.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListAliasesResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("ListAliases");
            ...
            while (context.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "Aliases":
                        {
                            context.AddPathSegment("Aliases");
                            var unmarshaller = new CborListUnmarshaller<Alias, AliasUnmarshaller>(AliasUnmarshaller.Instance);
