...
namespace Amazon.GameLift.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeMatchmakingResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("DescribeMatchmaking");
            ...
            while (context.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "TicketList":
                        {
                            context.AddPathSegment("TicketList");
                            var unmarshaller = new CborListUnmarshaller<MatchmakingTicket, MatchmakingTicketUnmarshaller>(MatchmakingTicketUnmarshaller.Instance);
