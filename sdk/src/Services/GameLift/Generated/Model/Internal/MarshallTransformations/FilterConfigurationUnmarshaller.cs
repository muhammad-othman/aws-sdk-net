...
namespace Amazon.GameLift.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FilterConfigurationUnmarshaller : ICborUnmarshaller<FilterConfiguration, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public FilterConfiguration Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (context.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "AllowedLocations":
                        {
                            context.AddPathSegment("AllowedLocations");
