...
namespace Amazon.GameLift.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PlayerLatencyPolicyUnmarshaller : ICborUnmarshaller<PlayerLatencyPolicy, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public PlayerLatencyPolicy Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (context.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "MaximumIndividualPlayerLatencyMilliseconds":
                        {
                            context.AddPathSegment("MaximumIndividualPlayerLatencyMilliseconds");
                    ...
                    case "PolicyDurationSeconds":
                        {
                            context.AddPathSegment("PolicyDurationSeconds");
                            var unmarshaller = CborNullableIntUnmarshaller.Instance;
