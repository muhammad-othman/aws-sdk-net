...
namespace Amazon.GameLift.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListComputeResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("ListCompute");
            ...
            while (context.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "ComputeList":
                        {
                            context.AddPathSegment("ComputeList");
                            var unmarshaller = new CborListUnmarshaller<Compute, ComputeUnmarshaller>(ComputeUnmarshaller.Instance);
                            response.ComputeList = unmarshaller.Unmarshall(context);
