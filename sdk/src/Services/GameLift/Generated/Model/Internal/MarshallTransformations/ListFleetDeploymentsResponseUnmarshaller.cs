...
namespace Amazon.GameLift.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListFleetDeploymentsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("ListFleetDeployments");
            ...
            while (context.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "FleetDeployments":
                        {
                            context.AddPathSegment("FleetDeployments");
                            var unmarshaller = new CborListUnmarshaller<FleetDeployment, FleetDeploymentUnmarshaller>(FleetDeploymentUnmarshaller.Instance);
                            response.FleetDeployments = unmarshaller.Unmarshall(context);
