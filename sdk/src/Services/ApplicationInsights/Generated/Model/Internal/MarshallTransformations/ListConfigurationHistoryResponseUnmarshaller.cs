...
namespace Amazon.ApplicationInsights.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListConfigurationHistoryResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("ListConfigurationHistory");
            ...
            while (context.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "EventList":
                        {
                            context.AddPathSegment("EventList");
                            var unmarshaller = new CborListUnmarshaller<ConfigurationEvent, ConfigurationEventUnmarshaller>(ConfigurationEventUnmarshaller.Instance);
