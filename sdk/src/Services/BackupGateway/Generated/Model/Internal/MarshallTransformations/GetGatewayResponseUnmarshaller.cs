...
namespace Amazon.BackupGateway.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetGatewayResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("GetGateway");
            ...
            while (context.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "Gateway":
                        {
                            context.AddPathSegment("Gateway");
                            var unmarshaller = GatewayDetailsUnmarshaller.Instance;
