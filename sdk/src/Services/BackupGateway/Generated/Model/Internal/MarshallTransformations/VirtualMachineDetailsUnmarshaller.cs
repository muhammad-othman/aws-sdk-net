...
namespace Amazon.BackupGateway.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class VirtualMachineDetailsUnmarshaller : ICborUnmarshaller<VirtualMachineDetails, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public VirtualMachineDetails Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (context.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "VmwareTags":
                        {
                            context.AddPathSegment("VmwareTags");
                            var unmarshaller = new CborListUnmarshaller<VmwareTag, VmwareTagUnmarshaller>(VmwareTagUnmarshaller.Instance);
