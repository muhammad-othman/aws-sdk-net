...
{
    /// <summary>
    /// Response Unmarshaller for GetRevenueAttributionAllocation operation
    /// </summary>  
    public class GetRevenueAttributionAllocationResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRevenueAttributionAllocationResponse response = new GetRevenueAttributionAllocationResponse();
            var reader = context.Reader;
            context.AddPathSegment("GetRevenueAttributionAllocation");
            ...
            while (context.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "RevenueAttributionAllocationId":
                        {
                            ...
                            var unmarshaller = CborStringUnmarshaller.Instance;
                            response.RevenueAttributionAllocationId = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    case "RevenueAttributionIdentifier":
                        {
                            ...
                            var unmarshaller = CborStringUnmarshaller.Instance;
                            response.RevenueAttributionIdentifier = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    ...
                    case "RevenueAttributionRevision":
                        {
                            context.AddPathSegment("RevenueAttributionRevision");
                            var unmarshaller = CborStringUnmarshaller.Instance;
                            response.RevenueAttributionRevision = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
        ...
        private static GetRevenueAttributionAllocationResponseUnmarshaller _instance = new GetRevenueAttributionAllocationResponseUnmarshaller();        

        internal static GetRevenueAttributionAllocationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRevenueAttributionAllocationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
