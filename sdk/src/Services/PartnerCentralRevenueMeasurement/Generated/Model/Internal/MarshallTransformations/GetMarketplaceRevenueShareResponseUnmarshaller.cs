...
{
    /// <summary>
    /// Response Unmarshaller for GetMarketplaceRevenueShare operation
    /// </summary>  
    public class GetMarketplaceRevenueShareResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetMarketplaceRevenueShareResponse response = new GetMarketplaceRevenueShareResponse();
            var reader = context.Reader;
            context.AddPathSegment("GetMarketplaceRevenueShare");
                    ...
                    case "TotalActiveMarketplaceRevenueShareAllocationCount":
                        {
                            ...
                            var unmarshaller = CborNullableIntUnmarshaller.Instance;
                            response.TotalActiveMarketplaceRevenueShareAllocationCount = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    case "TotalMarketplaceRevenueShareAllocationCount":
                        {
                            ...
                            var unmarshaller = CborNullableIntUnmarshaller.Instance;
                            response.TotalMarketplaceRevenueShareAllocationCount = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    default:
        ...
        private static GetMarketplaceRevenueShareResponseUnmarshaller _instance = new GetMarketplaceRevenueShareResponseUnmarshaller();        

        internal static GetMarketplaceRevenueShareResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMarketplaceRevenueShareResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
