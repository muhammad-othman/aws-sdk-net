...
{
    /// <summary>
    /// Response Unmarshaller for ListMarketplaceRevenueShares operation
    /// </summary>  
    public class ListMarketplaceRevenueSharesResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListMarketplaceRevenueSharesResponse response = new ListMarketplaceRevenueSharesResponse();
            var reader = context.Reader;
            context.AddPathSegment("ListMarketplaceRevenueShares");
            ...
            while (context.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "MarketplaceRevenueShareSummaries":
                        {
                            context.AddPathSegment("MarketplaceRevenueShareSummaries");
                            var unmarshaller = new CborListUnmarshaller<MarketplaceRevenueShareSummary, MarketplaceRevenueShareSummaryUnmarshaller>(MarketplaceRevenueShareSummaryUnmarshaller.Instance);
                            response.MarketplaceRevenueShareSummaries = unmarshaller.Unmarshall(context);
        ...
        private static ListMarketplaceRevenueSharesResponseUnmarshaller _instance = new ListMarketplaceRevenueSharesResponseUnmarshaller();        

        internal static ListMarketplaceRevenueSharesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListMarketplaceRevenueSharesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
