...
{
    /// <summary>
    /// Response Unmarshaller for CreateRevenueAttribution operation
    /// </summary>  
    public class CreateRevenueAttributionResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateRevenueAttributionResponse response = new CreateRevenueAttributionResponse();
            var reader = context.Reader;
            context.AddPathSegment("CreateRevenueAttribution");
        ...
        private static CreateRevenueAttributionResponseUnmarshaller _instance = new CreateRevenueAttributionResponseUnmarshaller();        

        internal static CreateRevenueAttributionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateRevenueAttributionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
