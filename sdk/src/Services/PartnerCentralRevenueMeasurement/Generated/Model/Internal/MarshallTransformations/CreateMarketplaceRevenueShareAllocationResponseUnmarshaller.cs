...
{
    /// <summary>
    /// Response Unmarshaller for CreateMarketplaceRevenueShareAllocation operation
    /// </summary>  
    public class CreateMarketplaceRevenueShareAllocationResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateMarketplaceRevenueShareAllocationResponse response = new CreateMarketplaceRevenueShareAllocationResponse();
            var reader = context.Reader;
            context.AddPathSegment("CreateMarketplaceRevenueShareAllocation");
        ...
        private static CreateMarketplaceRevenueShareAllocationResponseUnmarshaller _instance = new CreateMarketplaceRevenueShareAllocationResponseUnmarshaller();        

        internal static CreateMarketplaceRevenueShareAllocationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateMarketplaceRevenueShareAllocationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
