...
{
    /// <summary>
    /// Response Unmarshaller for UpdateRevenueAttribution operation
    /// </summary>  
    public class UpdateRevenueAttributionResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdateRevenueAttributionResponseUnmarshaller _instance = new UpdateRevenueAttributionResponseUnmarshaller();        

        internal static UpdateRevenueAttributionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateRevenueAttributionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
