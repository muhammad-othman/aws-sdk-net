...
{
    /// <summary>
    /// Response Unmarshaller for MarketplaceProductSummary Object
    /// </summary>  
    public class MarketplaceProductSummaryUnmarshaller : ICborUnmarshaller<MarketplaceProductSummary, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public MarketplaceProductSummary Unmarshall(CborUnmarshallerContext context)
        {
            MarketplaceProductSummary unmarshalledObject = new MarketplaceProductSummary();
        ...
        private static MarketplaceProductSummaryUnmarshaller _instance = new MarketplaceProductSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static MarketplaceProductSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
