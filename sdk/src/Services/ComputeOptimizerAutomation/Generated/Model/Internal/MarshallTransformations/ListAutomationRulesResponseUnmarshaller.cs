...
namespace Amazon.ComputeOptimizerAutomation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListAutomationRulesResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("ListAutomationRules");
            ...
            while (context.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "automationRules":
                        {
                            context.AddPathSegment("AutomationRules");
                            var unmarshaller = new CborListUnmarshaller<AutomationRule, AutomationRuleUnmarshaller>(AutomationRuleUnmarshaller.Instance);
                            response.AutomationRules = unmarshaller.Unmarshall(context);
