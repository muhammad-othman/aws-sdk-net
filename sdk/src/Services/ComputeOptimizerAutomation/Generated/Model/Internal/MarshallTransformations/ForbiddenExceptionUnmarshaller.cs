...
namespace Amazon.ComputeOptimizerAutomation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ForbiddenExceptionUnmarshaller : ICborErrorResponseUnmarshaller<ForbiddenException, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public ForbiddenException Unmarshall(CborUnmarshallerContext context)
        {
        ...
        /// <returns></returns>
        public ForbiddenException Unmarshall(CborUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse)
        {
            ...
            context.AddPathSegment("ForbiddenException");
