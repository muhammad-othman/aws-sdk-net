...
namespace Amazon.ComputeOptimizerAutomation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ResourceDetailsUnmarshaller : ICborUnmarshaller<ResourceDetails, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public ResourceDetails Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (context.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "ebsVolume":
                        {
                            context.AddPathSegment("EbsVolume");
