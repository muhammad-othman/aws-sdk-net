...
{
    /// <summary>
    /// Response Unmarshaller for GetAutomationRule operation
    /// </summary>  
    public class GetAutomationRuleResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetAutomationRuleResponse response = new GetAutomationRuleResponse();
            var reader = context.Reader;
            context.AddPathSegment("GetAutomationRule");
        ...
        private static GetAutomationRuleResponseUnmarshaller _instance = new GetAutomationRuleResponseUnmarshaller();        

        internal static GetAutomationRuleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAutomationRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
