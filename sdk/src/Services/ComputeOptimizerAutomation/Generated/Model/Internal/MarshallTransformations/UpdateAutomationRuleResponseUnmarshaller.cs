...
{
    /// <summary>
    /// Response Unmarshaller for UpdateAutomationRule operation
    /// </summary>  
    public class UpdateAutomationRuleResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateAutomationRuleResponse response = new UpdateAutomationRuleResponse();
            var reader = context.Reader;
            context.AddPathSegment("UpdateAutomationRule");
        ...
        private static UpdateAutomationRuleResponseUnmarshaller _instance = new UpdateAutomationRuleResponseUnmarshaller();        

        internal static UpdateAutomationRuleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAutomationRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
