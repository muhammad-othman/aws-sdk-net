...
{
    /// <summary>
    /// Response Unmarshaller for ListRecommendedActionSummaries operation
    /// </summary>  
    public class ListRecommendedActionSummariesResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListRecommendedActionSummariesResponse response = new ListRecommendedActionSummariesResponse();
            var reader = context.Reader;
            context.AddPathSegment("ListRecommendedActionSummaries");
            ...
            while (context.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "recommendedActionSummaries":
                        {
                            context.AddPathSegment("RecommendedActionSummaries");
                            var unmarshaller = new CborListUnmarshaller<RecommendedActionSummary, RecommendedActionSummaryUnmarshaller>(RecommendedActionSummaryUnmarshaller.Instance);
                            response.RecommendedActionSummaries = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    default:
        ...
        private static ListRecommendedActionSummariesResponseUnmarshaller _instance = new ListRecommendedActionSummariesResponseUnmarshaller();        

        internal static ListRecommendedActionSummariesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListRecommendedActionSummariesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
